...
register(
    id="cube-single-v0",
    entry_point="ogbenchTL.manipspace.envs.cube_env:CubeEnv",
...
register(
    id="scene-v0",
    entry_point="ogbenchTL.manipspace.envs.scene_env:SceneEnv",
...
register(
    id="puzzle-3x3-v0",
    entry_point="ogbenchTL.manipspace.envs.puzzle_env:PuzzleEnv",
    max_episode_steps=500,
    kwargs=dict(
        env_type="3x3",
    ),
...
register(
    id="tl-manip-v0",
    entry_point="ogbenchTL.manipspace.envs.tl_manip_env:TLManipEnv",
